...
return new class extends Migration
{
    ...
    read_loop: LOOP
        ...
        CREATE TEMPORARY TABLE tmp_table_not_showed
          ...
          FROM questions q
          WHERE q.id NOT IN (
              select distinct id FROM tmp_table_showed)
            AND q.questionable_id = v_id
            AND q.questionable_type = 'App\\Models\\Topic'
            AND q.question_in_edit_mode = 'no'
            AND q.is_visible = 'yes'
        ...
        INSERT INTO tmp_selected_questions
              SELECT id FROM tmp_table_not_showed ORDER BY RAND() LIMIT npregs_by_topic;
        ...
        IF c < npregs_by_topic THEN
          ...
          INSERT INTO  tmp_selected_questions
            SELECT id FROM tmp_table_not_showed ORDER BY RAND() LIMIT c;
        END IF;

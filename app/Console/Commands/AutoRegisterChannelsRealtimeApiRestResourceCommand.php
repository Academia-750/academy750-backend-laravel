...
class AutoRegisterChannelsRealtimeApiRestResourceCommand extends Command
{
    use helpersJsonApi;

    protected $signature = 'register:json-api:channels {name}';

    protected $description = "Hace el registro de los canales realtime del nuevo recurso creado con cierto nombre";
    ...
    public function getStubNewLines():string{
        ...
        return "require __DIR__ . '/channels/{$nameResource}.channels.php';

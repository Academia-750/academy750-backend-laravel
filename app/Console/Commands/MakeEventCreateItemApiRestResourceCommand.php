...
class MakeEventCreateItemApiRestResourceCommand extends Command
{

    use helpersJsonApi;

    protected $signature = 'make:json-api:event-create {name}';

    protected $description = "Crea el 'Evento' especifico para notificar la creacion de un nuevo recurso";
    ...
    public function handle():void
    {
        ...
        if( ! $this->filesystem->exists($path) ){
            ...
            $this->info("Event Realtime 'Create Item' api Rest: {$path} created successfully!");
        }else{
    ...
    public function getStubVariables():array{
        ...
        return [
            ...
            "class" => 'Create' . $this->getSingularClassName(Str::camel($this->argument('name'))) .'Event',
    ...
    public function getStubPath():string{
        return base_path("stubs\\SymbioticWorld\\events\\event-create.item.api-rest.stub");
    }
    ...
    public function getSourceFilePath():string{
        ...
        return base_path("app/Events/Api/" . $resourceNamePlural . '/' . 'Create' . $resourceNameSingular . 'Event.php'); //App/Events/Api/ProcessTimeEvent.php
    }

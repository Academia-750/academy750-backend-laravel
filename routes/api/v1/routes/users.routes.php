...
Route::get('users/{student}', [UsersController::class, 'read'])->name('api.v1.users.read');
Route::post('users/create', [UsersController::class, 'create'])->name('api.v1.users.create');
Route::patch('users/update/{student}', [UsersController::class, 'update'])->name('api.v1.users.update');
Route::delete('users/delete/{student}', [UsersController::class, 'delete'])->name('api.v1.users.soft-delete');

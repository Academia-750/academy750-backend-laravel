...
Route::get("oppositions/{opposition}/topic/{topic}/relationship/subtopics", [OppositionsController::class, 'get_relationship_subtopics'])->name('api.v1.oppositions.relationships.subtopics');

...
Route::get("topics/{topic}/relationship/oppositions/{opposition}", [TopicsController::class, 'get_relationship_a_opposition'])->name('api.v1.topics.relationships.oppositions.record');

...
Route::put('material/{id}/update', [MaterialController::class, 'postEditMaterial'])->middleware('onlyAdmin');
Route::delete('material/{id}/delete', [MaterialController::class, 'deleteMateria;'])->middleware('onlyAdmin');
